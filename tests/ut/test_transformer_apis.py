...
def test_transformer_encoder():
    """
    Feature: Test Transformer Encoder API
...
def test_transformer_encoder_layer():
    """
    Feature: Test Transformer Encoder Layer API
...
def test_transformer_decoder():
    """
    Feature: Test Transformer Decoder API
...
def test_transformer_decoder_layer():
    """
    Feature: Test Transformer Decoder Layer API
...
def test_multihead_attention():
    """
    Feature: Test MultiHead Attention API
    Description: Test MultiHead Attention model.
    Expectation: No exception
    """
...
def test_feedforward_layer():
    """
    Feature: Test Feedforward layer.
    Description: Test the Feedforward layer
    Expectation: No exception
    """
...
def test_cross_entroy():
    """
    Feature: Test cross entory loss.
...
def test_sparse_attention():
    """
    Feature: Test the sparse attention layer.
    Description: Test the forward
    Expectation: No exception
    """
