...
echo "bash examples/image_classification/swin_base_p4w7_predict_on_imagenet1k.sh"
echo "The data setting could refer to ./docs/task_cards/image_classification.md"
echo "It is better to use absolute path."
echo "=============================================================================================================="

python run_mindformer.py --config ./configs/swin/run_swin_base_p4w7_224_100ep.yaml --run_mode predict \
